...
# feature = stub.createQueue(meu_qoelho_mq_pb2.Queue(name="test8", type=2))
# print(feature)

print('aaaa')
# feature = stub.publishMessage(meu_qoelho_mq_pb2.PublishMessageRequest(queueName="test0", message=meu_qoelho_mq_pb2.MessageType(text_message="EITA9")))
# print(feature)
